...
inline RGBColor Phong::Ambient(const Intersection& inter, const Vector& wi, const RGBColor& li) const
{
	return ambientBRDF->Rho(wi, -inter.ray.d, inter.normal) * li;
}

inline RGBColor Phong::L(const Intersection& inter, const Vector& wi, const RGBColor& li) const
{
