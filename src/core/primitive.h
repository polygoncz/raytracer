...
/**
 * @file 
 * V souboru jsou definovány bázové třídy a rozhraní pro práci s objekty ve scéně.
 */
...
public:
	...
	/**
	 * Výchozí implementace metody @a Primitive::CanIntersect().
	 * @see Primitive::CanIntersect()
	 * @return true
	 */
	virtual bool CanIntersect() const;

	/**
	 * Výchozí implementace metody @a Primitive::Refine(vector<Reference<Primitive> >&)
	 * Těleso vloží do vectoru samo sebe.
	 * @see Primitive::Refine(vector<Reference<Primitive> >&)
	 */
...
protected:
	mutable Reference<Material> material; ///< Materiál tělesa.
};
