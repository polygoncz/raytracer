...
inline RGBColor Specular::F(const Vector& wi, const Vector& wo, const Normal& n) const
{
...
inline RGBColor Specular::SampleF(const Vector& wi, const Vector& wo, const Normal& n) const
{
    return BLACK;
}

inline RGBColor Specular::Rho(const Vector& wi, const Vector& wo, const Normal& n) const
{
    return BLACK;
}